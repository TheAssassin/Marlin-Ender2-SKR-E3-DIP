...
#define STRING_CONFIG_H_AUTHOR "TheAssassin" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
// own measured value for E steps
// other stuff read from the upstream Marlin example
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 118 }
